this.sideBarEdit("Side Bar Tweaks", [
  ...
  {
    label: "Config",
    href: "/dashboard/plugin/jkablez/mediah-plugin/side-bar-tweaks",
    ...
    return range.createContextualFragment(`
      <div class="p-4">
        ...
        <form class="space-y-4">
            ...
            <button class="dark:bg-muted dark:disabled:bg-muted/90 bg-primary disabled:bg-primary/90 transition-all text-sm text-white font-medium h-9 inline-flex px-4 text-center justify-center rounded-md items-center">Save</button>
        </form>
      </div>
    `);
  }
