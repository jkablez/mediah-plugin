...
class Handle {
  ...
  createRoot() {
    ...
    return range.createContextualFragment(`
          <button class="h-6 cursor-pointer hover:text-foreground transition-all text-muted-foreground rounded-md bg-background border flex items-center justify-center absolute -right-2 top-0 bottom-0 my-auto ${this.site.handleHidden ? 'hidden' : ''}">
